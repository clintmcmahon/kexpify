...
if __name__ == '__main__':
    ...
    description = "A weekly playlist recapping Greg Vandy's latest Roadhouse show on KEXP Seattle. Emphasizing the blues and other traditional styles of American music. Updated every Wednesday. Support the music and donate @ KEXP.org"
